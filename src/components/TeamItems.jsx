...
function TeamItem({ name, imgUrl, introduction, role }) {
  return (
    <a href="#" className="block md:flex md:flex-row md:justify-center md:items-center mb-4">
      <div className="w-full md:w-56 h-full border-4 border-blue-400 hover:border-blue-500 p-4 flex flex-col justify-between box-bordergit ">
        <div className="mb-4 md:mb-0">
          <img
            src={imgUrl}
            alt="name of team member"
            className="object-contain w-full h-40 md:h-auto border-4 border-blue-500 rounded-xl"
          />
